...
[LinkedIn](https://www.linkedin.com/in/kairui-jeffrey-liu/) · [Experience & contribution details](experience.md)

## Product internship · 光启之境
...
[**LumaQ on the App Store**](https://apps.apple.com/cn/app/lumaq-%E7%9B%B8%E6%9C%BA/id6756262410) lists sparkles, collage and Camera Control in **1.3.0**. [My contribution and product choices](experience.md#lightmeta--ai-camera-product-work) · [FrameText: independent MediaPipe prototype](https://github.com/Jeffreyliu0131/frame-text-demo)

## Selected projects

### 01 · [ShopSteward](https://github.com/yhnapoleon/ShopSteward) — Restocking decisions under cash constraints
...
[**Product walkthrough →**](https://shopsteward-showcase.jeffrey-131.chatgpt.site) · [Team repository](https://github.com/yhnapoleon/ShopSteward) · [Example delivery: workspace results and comparisons](https://github.com/yhnapoleon/ShopSteward/pull/17)

### 02 · [Meeting Agent](https://github.com/Jeffreyliu0131/meeting-agent) — Follow the discussion without interrupting it
...
[**Screenshots & quick review →**](https://github.com/Jeffreyliu0131/meeting-agent#quick-review) · [Product choices](https://github.com/Jeffreyliu0131/meeting-agent/blob/main/docs/decisions.md) · [Validation & limits](https://github.com/Jeffreyliu0131/meeting-agent#validation-status)

### 03 · [ThinkBud](https://github.com/Jeffreyliu0131/thinkbud-ai) — Help primary-school learners think through a problem
...
[**No-install product walkthrough →**](https://jeffreyliu0131.github.io/thinkbud-ai/) · [Maths practice](https://jeffreyliu0131.github.io/thinkbud-ai/#/practice) · [Source & subject scope](https://github.com/Jeffreyliu0131/thinkbud-ai#product-scope-and-current-coverage) · [Product decisions](https://github.com/Jeffreyliu0131/thinkbud-ai/blob/main/docs/CASE_STUDY.md)

### 04 · AI Glasses — Voice access to industrial work instructions
...
[**Responsibilities, trade-offs & reported results →**](experience.md#penn-state--work-instruction-voice-assistant)
...
Earlier experience: mobile OS issue reproduction at **Xiaomi** and Python debugging instruction as a **Penn State teaching assistant**. [Details](experience.md#earlier-experience)

Mandarin · English | [Connect on LinkedIn →](https://www.linkedin.com/in/kairui-jeffrey-liu/)
